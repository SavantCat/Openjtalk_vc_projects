========================================================================
    ダイナミック リンク ライブラリ: openjtalklib プロジェクトの概要
========================================================================

この openjtalklib DLL は、AppWizard により作成されました。

このファイルには、openjtalklib アプリケーションを構成する各ファイルの内容の概要が含まれています。

openjtalklib.vcxproj
